...
Сценарий: создание документа ПоступлениеТоваровУслуг с заполнением всех реквизитов
    ...
    * И заполняю табличную часть Товары
        ...
        //Когда в таблице "Товары" я завершаю редактирование строки поле с именем 'ТоварыСумма' имеет значение "100,00" //Ошибка на данном шаге: Не найдена процедура или функция для выполнения шага: Когда в таблице "Товары" я завершаю редактирование строки поле с именем 'ТоварыСумма' имеет значение "100,00"
	* И я заполняю табличную часть Услуги   
        ...
        //Тогда поле с именем 'УслугиСумма' равно переменной '50,00'
    ...
    * Тогда в форме списка документов Поступления товаров и услуг появляется созданный документ
        //И в таблице "Список" поле с именем "СуммаДокумента" имеет значение "150,00"