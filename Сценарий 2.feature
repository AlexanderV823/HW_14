...
Сценарий: я создаю новый документ ПоступлениеТоваровУслуг с указанием "НаименованиеОрганизации", "НаименованиеКонтрагента", "ДоговорКонтрагента", "ИмяКонтактногоЛица", "КонтактныйТелефонКонтактногоЛица", "ДолжностьКонтактногоЛица", "НаименованиеТовара", "КоличествоТовара", "ЦенаТовара", "НаименованиеУслуги", "ЦенаУслуги" 
    ...
    * И заполняю табличную часть Товары
		...
		И я запоминаю значение выражения 'Формат((Число([ЦенаТовара]) * Число([КоличествоТовара])),"ЧДЦ=2")' в переменную "ПеременнаяСуммаТовары"
	...
	* И я заполняю табличную часть Услуги   
        ...
        И я запоминаю значение выражения 'Формат((Число([ЦенаУслуги]) * Число(Контекст.ПеременнаяКоличествоУслуги)),"ЧДЦ=2")' в переменную "ПеременнаяСуммаУслуги"
