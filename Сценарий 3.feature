...
@ПримерИспользования: И я создаю новый документ ОплатаПоставщику с указанием "НаименованиеОрганизация", "НаименованиеКонтрагент", "НаименованиеДоговорКонтрагента", "НаименованиеКонтактноеЛицо", "КонтактныйТелефонКонтактногоЛица", "ДолжностьКонтактногоЛица", "Сумма"
...
Сценарий: я создаю новый документ ОплатаПоставщику с указанием "НаименованиеОрганизация", "НаименованиеКонтрагент", "НаименованиеДоговорКонтрагента", "НаименованиеКонтактноеЛицо", "КонтактныйТелефонКонтактногоЛица", "ДолжностьКонтактногоЛица", "Сумма"
	...
	* И я заполняю реквизиты шапки документа	
		...
		И в поле с именем 'Наименование' я ввожу текст "НаименованиеОрганизация"
		...
		И в поле с именем 'Наименование' я ввожу текст "НаименованиеКонтрагент"
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
		...
		И элемент формы 'Контрагент' стал равен "НаименованиеКонтрагент"
		И элемент формы 'Организация' стал равен "НаименованиеОрганизация"
		И в поле с именем 'Наименование' я ввожу текст "НаименованиеДоговорКонтрагента"
		...
		И в поле с именем 'Наименование' я ввожу текст "НаименованиеКонтактноеЛицо"
	...
	* Тогда в форме списка документов Оплата поставщику появляется созданный документ
		Тогда я жду, что таблица "Список" станет содержать строки в течение 5 секунд:
			...
			| [НаименованиеДоговорКонтрагента]	 | [НаименованиеОрганизация]  | [НаименованиеКонтрагент]    | $ПеременнаяСумма$ |