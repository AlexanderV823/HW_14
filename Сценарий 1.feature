...
@ПримерИспользования: И я создаю новый элемент справочника Номенклатура
...
Сценарий: создание элемента справочника Номенклатура с указанием "НаименованиеНоменклатуры", "ГруппаНоменклатуры", "НоменклатурнаяГруппа" и "ЕдиницаИзмерения"
    ...
    * И я заполняю обязательные реквизиты 
        ...
        И в поле с именем 'Наименование' я ввожу текст [ГруппаНоменклатуры]
        ...
        И в поле с именем 'Наименование' я ввожу текст [НоменклатурнаяГруппа]
        И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
        ...
        И в поле с именем 'Наименование' я ввожу текст [ЕдиницаИзмерения]
        И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
    ...
    * Тогда в списке появляется созданный элемент
	    Тогда я жду, что таблица "Список" станет содержать строки в течение 5 секунд:
	    	...
	    	| [НаименованиеНоменклатуры]  | [НоменклатурнаяГруппа]  | [ЕдиницаИзмерения]  | 'Товар'            |
