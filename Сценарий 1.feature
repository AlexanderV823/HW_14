...
@ПримерИспользования: И я создаю новый элемент справочника Номенклатура с указанием "НаименованиеНоменклатуры", "НаименованиеГруппы", "НаименованиеНоменклатурнойГруппы", "НаименованиеЕдиницыИзмерения", "ТоварИлиУслуга"
...
Сценарий: я создаю новый элемент справочника Номенклатура с указанием "НаименованиеНоменклатуры", "НаименованиеГруппы", "НаименованиеНоменклатурнойГруппы", "НаименованиеЕдиницыИзмерения", "ТоварИлиУслуга"
    ...
    * Тогда в списке появляется созданный элемент
	    Тогда я жду, что таблица "Список" станет содержать строки в течение 5 секунд:
	    	...
	    	| [НаименованиеНоменклатуры]  | [НаименованиеНоменклатурнойГруппы]  	| [НаименованиеЕдиницыИзмерения]  			  | [ТоварИлиУслуга]   |