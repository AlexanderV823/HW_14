...
### **14.10.2024**
- Отредактирован файл Сценарий 4.feature. Исправлен ошибочный отступ;
- Отредактирован файл Сценарий 3.feature. Реализован выбор значений Организации, Контрагента, Договора и Контактного лица по строке.   